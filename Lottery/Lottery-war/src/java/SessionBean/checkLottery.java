...
public class checkLottery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Servlet checkLottery</title>");            
            out.println("</head>");
            out.println("<body>");
            int val=Integer.parseInt(request.getParameter("val"));
             out.println(" <div class=\"w3-container w3-teal\">\n" +
"            <h1>Lottery System</h1>\n" +
"            <h4 style=\"float:right\"><a href=\"index.html\" style=\"text-decoration: none\">Logout</a></h4>\n" +
"        </div>");
            out.println("<h1> " + client1.help(val)+ "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
